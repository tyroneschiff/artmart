...
- **Video clips → YouTube Shorts**: scoped, not built — `growth/video-clips-plan.md` (Kling 2.1 i2v on fal.ai, per-image motion-prompt strategy, Cloudinary watermark, manual-upload-first distribution, phased rollout, ~$0.25/clip). Recommends shipping the cheap deterministic before/after reveal FIRST, generative clip as a premium upgrade.
