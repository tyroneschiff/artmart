...
1. **[RETENTION] Push Token Collection (DB)**
...
2. **[RETENTION] Push Token Collection (App)**
...
3. **[GROWTH] Post-Publish Viral Loop**
...
4. **[POLISH] Theme Token Adoption - Create**
...
5. **[POLISH] Theme Token Adoption - Piece Detail**
    * **The Micro-Task:** Refactor `app/app/piece/[id].tsx` to replace the 150-line `StyleSheet.create` block with `type`, `btn`, and `card` tokens for all headers and action buttons.
    * **Why:** The Piece Detail screen is our primary sales page; it must be the purest expression of our design system to build trust.

6. **[POLISH] Theme Token Adoption - Profile**
...
7. **[POLISH] Theme Token Adoption - My Stores**
